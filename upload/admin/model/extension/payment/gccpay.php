...
class ModelExtensionPaymentGCCPay extends Model {
	...
	public function install() {
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "gccpay_transaction` (
			`id` int(11) NOT NULL AUTO_INCREMENT,
			`order_id` int(11) NOT NULL DEFAULT '0',
			`amounts` double NOT NULL,
			`gccpayid` varchar(128) NOT NULL DEFAULT '',
			`ticket`  varchar(128) NOT NULL DEFAULT '',
			`status` varchar(10) NOT NULL DEFAULT '',
			`merchantOrderId` varchar(32) NOT NULL DEFAULT '',
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "gccpay_transaction`");
	}
